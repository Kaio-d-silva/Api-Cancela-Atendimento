...
USER_DB_PACS_MEDLINK : process.env.USER_DB_PACS_MEDLINK,
PASSWORD_DB_PACS_MEDLINK : process.env.PASSWORD_DB_PACS_MEDLINK,
CONNECT_STRING_PACS_MEDLINK : process.env.CONNECT_STRING_PACS_MEDLINK,
};